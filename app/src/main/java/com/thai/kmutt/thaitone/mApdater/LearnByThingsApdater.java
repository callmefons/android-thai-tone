...
import com.thai.kmutt.thaitone.mDetail.LearnByThingsDetailActivity;
...
public class LearnByThingsApdater extends BaseAdapter{
    ...
    ArrayList<Object> learan_by_things;

    TreeSet<Integer> sectionHeader = new TreeSet<Integer>();

    LayoutInflater inflater;

    public LearnByThingsApdater(Context c, ArrayList<Object> learan_by_things) {
        this.c = c;
        this.learan_by_things = learan_by_things;
    ...
    @Override
    public int getCount() {
        return learan_by_things.size();
    }

    @Override
    public Object getItem(int position) {
        return learan_by_things.get(position);
    }
    ...
    public int getItemViewType(int position) {
        if (getItem(position) instanceof LearnByThings) {
            return TYPE_ITEM;
        }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if(view == null)
        {
            ...
            switch (type) {
                case TYPE_ITEM:
                    view = inflater.inflate(R.layout.learn_by_things_list, viewGroup, false);
                    break;
                case TYPE_SEPARATOR:
